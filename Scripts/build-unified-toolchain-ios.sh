...
rm -rf "$BUILD_NATIVE" "$BUILD_IOS" "$INSTALL"
mkdir -p "$BUILD_NATIVE" "$BUILD_IOS" "$INSTALL"

# Build native generators used by the iOS cross-build.
